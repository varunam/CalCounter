...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE = "CREATE TABLE " + Constants.TABLE_NAME + " (" + Constants.KEY_ID + " INTEGER PRIMARY KEY,"
                + Constants.FOOD_NAME + " TEXT, " + Constants.FOOD_CALORIES_NAME + " INTEGER," + Constants.DATE_NAME + " LONG);";
    ...
    public ArrayList<Food> getFood(){
        ...
        String query = "SELECT * FROM " + Constants.TABLE_NAME + " ORDER BY " + Constants.DATE_NAME + " DESC;";

        /*Cursor cursor = dba.query(Constants.TABLE_NAME, new String[] { Constants.KEY_ID, Constants.FOOD_NAME, Constants.FOOD_CALORIES_NAME,
                        Constants.DATE_NAME},null,null,null,null, " DESC");*/
